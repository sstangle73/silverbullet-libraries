...
A chapter's frontmatter names the people and places in it. A page's type says which of those lists to look in, and a chapter names a page by the page's `name_`.
