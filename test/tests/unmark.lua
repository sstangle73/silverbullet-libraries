...
test("kit: unmark takes a find back, uses and all, with undo", "dm", function()
  ...
  eq(list(buttonsOf(gm.bar().html)), "Reveal | Reveal part… | Mark found")
...
test("kit: unmark met and visited, from the bar", "dm", function()
  ...
  eq(list(buttonsOf(gm.bar().html)), "Reveal all | Reveal part… | Unreveal | Mark met | Mark dead…")
  ...
  eq(list(buttonsOf(gm.bar().html)), "Reveal all | Unreveal | Mark visited")
end)
